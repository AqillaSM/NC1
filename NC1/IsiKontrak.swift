...
//    @State private var awalInput: String = "1"
    ...
    var body: some View {
        NavigationView {
            ...
            .background(
                NavigationLink(
                    destination: Compare(jumlahBoard: $jumlahBoard, awalInput: $awalInput, homeTeamInput: $homeTeamInput, visitorTeamInput: $visitorTeamInput, tinggiBoard: $tinggiBoard, data: $data).navigationBarBackButtonHidden(true), // Ganti dengan halaman tujuan yang tepat
